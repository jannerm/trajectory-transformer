...
**New**: Also see [Alexander Nikolin](https://github.com/Howuhh)'s fork with [attention caching and vectorized rollouts](https://github.com/Howuhh/faster-trajectory-transformer)!
